...
function openPopUp(obj) {
    chosenElementNo = elements.findIndex(std=> std.symbol === (obj.name));
    console.log(elements[chosenElementNo]);
    div.innerHTML = 
    `
    ...
    <p>${elements[chosenElementNo].summary}</p>
    </div>

    <div class="quickInfo">
    <h3>Infomation<h3>
    <p> Atomic Mass: ${elements[chosenElementNo].atomic_mass}</p>
    <p> Boiling Point: ${elements[chosenElementNo].boil}</p>
    <p> Category: ${elements[chosenElementNo].category}</p>
    <p> Color: ${elements[chosenElementNo].color}</p>
    <p> Density: ${elements[chosenElementNo].density}</p>
    <p> Discovered By: ${elements[chosenElementNo].discovered_by}</p>
    <p> Melting Point: ${elements[chosenElementNo].melt}</p>
    <p> Molar Heat: ${elements[chosenElementNo].molar_heat}</p>
    <p> Named By: ${elements[chosenElementNo].named_by}</p>
    <p> Atomic Number: ${elements[chosenElementNo].number}</p>
    <p> Period: ${elements[chosenElementNo].period}</p>
    <p> Phase at room temperture: ${elements[chosenElementNo].phase}</p>
    <a class="wikiLink" href=${elements[chosenElementNo].source}>  Wkipedia  </a>
    </div>

    <div class="bottomSection">
    <h4>${elements[chosenElementNo].xpos}</h4>
    <h4>${elements[chosenElementNo].ypos}</h4>
    <h4>${elements[chosenElementNo].shells}</h4>
    <h4>${elements[chosenElementNo].electron_configuration}</h4>
    <h4>${elements[chosenElementNo].electron_configuration_semantic}</h4>
    <h4>${elements[chosenElementNo].electron_affinity}</h4>
    <h4>${elements[chosenElementNo].electronegativity_pauling}</h4>
    <h4>${elements[chosenElementNo].ionization_energies}</h4>
    </div>
    `;
